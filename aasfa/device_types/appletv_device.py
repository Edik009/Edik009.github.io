"""Apple TV / Android TV device scanner"""
...
class AppleTVDevice(BaseDevice):
    ...
    def __init__(self, ip: str):
        super().__init__(ip)
        self.device_type = "appletv"

    def scan(self, mode: str = "standard") -> Dict[str, Any]:
        """Perform security scan on Apple TV / Android TV device"""
    ...
    def get_device_info(self) -> Dict[str, Any]:
        """Get Apple TV / Android TV device information"""
        return {
            "type": "Apple TV / Android TV",
    ...
    def create_scan_config(self, mode: str) -> ScanConfig:
        """Create Apple TV / Android TV scan configuration"""
        mode_mapping = {
            "fast": "fast",
            "standard": "full",
            "deep": "deep",
