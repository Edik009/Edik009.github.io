...
def get_network_vectors() -> Dict[int, Dict[str, Any]]:
    ...
    base_vectors = [
        ...
        (6, "ADB Over TCP", "ADB доступен через TCP", "check_adb_over_tcp_network"),
        (7, "ADB Pairing Misconfiguration", "Неправильная настройка ADB pairing", "check_adb_pairing_misc"),
